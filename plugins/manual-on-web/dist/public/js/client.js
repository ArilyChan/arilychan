...
const Profile = lazy(() => import('./Profile-8c4e386a.js')); // this component lazy loads data and code in parallel
...
const Home = lazy(() => import('./Home-b91bc550.js'));
const Settings = lazy(() => import('./Settings-b24ecf1b.js'));
const App = RouteHOC(() => {
  const [, pending, {
    matches
  }] = useContext(RouterContext);
