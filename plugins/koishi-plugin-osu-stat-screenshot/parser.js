module.exports = // Generated by Peggy 1.2.0.
  ...
  (function () {
    ...
    function peg$parse (input, options) {
      ...
      const peg$e45 = peg$literalExpectation('\xA0', false)
      ...
      const peg$e48 = peg$otherExpectation('end of line')
      ...
      const peg$e54 = peg$otherExpectation('comment')
      ...
      const peg$f0 = function (lines) {
        return lines.filter((line) => !line.comment)
      }
      const peg$f1 = function (comment) {
        return { comment }
      }
      const peg$f2 = function (line) {
        return line
      }
      const peg$f3 = function (username) {
        return username.join('').trim()
      }
      const peg$f4 = function (command) {
        return _rawCommand('bancho', command)
      }
      const peg$f5 = function (command) {
        return _rawCommand('sb', command)
      }
      const peg$f6 = function (q, user) {
        return { ...q, user }
      }
      const peg$f7 = function (q, id) {
        return { ...q, id }
      }
      const peg$f8 = function (q, user) {
        return { ...q, user }
      }
      const peg$f9 = function (q, mode) {
        return { ...q, mode }
      }
      const peg$f10 = function (m) {
        return m.join('')
      }
      const peg$f11 = function () {
        return { type: 'userpage' }
      }
      const peg$f12 = function (mode) {
        return { type: 'stat', mode }
      }
      const peg$f13 = function (mode) {
        return { type: 'recent-score', mode }
      }
      const peg$f14 = function (mode) {
        return { type: 'score', mode }
      }
      const peg$f15 = function (id) {
        return { id }
      }
      const peg$f16 = function (last) {
        return { last }
      }
      ...
      const peg$f19 = function (hours) {
        return hours
      }
      const peg$f20 = function (date) {
        return date
      }
      const peg$f21 = function (d) {
        return { from: d }
      }
      const peg$f22 = function (d) {
        return { to: d }
      }
      const peg$f23 = function () {
        return { type: 'set-user' }
      }
      const peg$f24 = function () {
        return { type: 'set-mode' }
      }
      const peg$f25 = function (id) {
        return parseInt(id.join(''))
      }
      const peg$f26 = function (year) {
