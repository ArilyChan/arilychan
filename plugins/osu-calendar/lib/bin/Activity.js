...
const xorshift_1 = require("xorshift");
class FortuneDailyResult {
    constructor(qqId = 'unknown', events, day = new Date()) {
        this.seedString = qqId.toString();
        this.today = day;
        this.seed = Math.ceil((0, seedrandom_1.default)(this.seedString)() * 1000000);
        ...
        const gen = new xorshift_1.XorShift([startOfToday.getTime(), this.seed, 2, 0]);
    ...
    getRandomArray(array, size = 1) {
        const resp = shuffle_seed_1.default.shuffle(array, this.rng.random());
        if (size === 1)
            return resp[0];
        else
...
exports.default = FortuneDailyResult;
